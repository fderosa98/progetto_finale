...
public interface AnnuncioDAO {
	...
	List<Annuncio> findAllLimited(Connection connection) throws DAOException;
	
	List<Annuncio> findFiltered(Connection connection, String marca, String modello, int prezzoMin, int prezzoMax, String orderBy) throws DAOException;
