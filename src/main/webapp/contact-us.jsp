...
<title>MacAuto - Contattaci</title>
<!--Bootstrap -->
        ...
        <div class="contact_form gray-bg">
          <form action="#" method="get">
            <div class="form-group">
              <label class="control-label">Nome e cognome <span>*</span></label>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control height-remove white_bg" rows="4"></textarea>
            </div>
            <div class="form-group">
              <button class="btn" type="submit">Invia <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
        ...
        <div class="contact_detail">
          <ul>
            <li>
              ...
              <div class="contact_info_m">Via Nuova, 138, 28883 Gravellona Toce VB</div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="tel:61-1234-567-90">+39 342 162 6277</a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:contact@exampleurl.com">paolo_maccari@outlook.com</a></div>
            </li>
          </ul>
          <div class="map_wrap">
