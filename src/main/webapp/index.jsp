  ...
  <nav id="navigation_bar" class="navbar navbar-expand-lg">
	...
	<div class="row header-row padding-remove">
      <div class="navbar-header">
      	<div class="logo"> <a href="index-2 U.html"><img src="assets/images/logo.png" alt="image"/></a> </div>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="nav navbar-nav">
          ...
          <li><a href="index-2 U.html"> Home</a></li> <!-- modifica del dropdown di Home-->
          <li><a href="about-us U.html">Chi siamo</a></li> <!-- modifica del dropdown di Chi siamo-->
          <li><a href="listing-classic U.html">Catalogo</a></li> <!-- modifica al dropdown catalogo-->
          <li><a href="contact-us F">Contattaci</a></li>
          ...
          <ul>
            <li class="dropdown"> <a href="#" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-user-circle" aria-hidden="true"></i></a>
              <ul class="dropdown-menu">
                ...
                <li><a href="post-vehicle.html">Pubblica un veicolo</a></li>
    	  ...
    	  <div class="carousel-item active">
              ...
              <div class="carousel-caption">
                 <div class="banner_text text-center div_zindex white-text">
                        ...
                        <h3>Abbiamo più di mille auto da scegliere. </h3>
                        <a href="listing-classic.jsp" class="btn">Per saperne di più</a> 
                    </div> 
              </div>
          </div>
        ...
        <h3>Trova l'auto dei tuoi sogni</h3>
          ...
          <form action="ricerca-annunci" method="get">
           ...
           <!--  <div class="form-group col-md-3 col-sm-6">
            ...
            <div class="form-group col-md-3 col-sm-6">
              <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Cerca Macchina </button>
            </div> 
			</div> 
          </form> 
        ...
        <div class="row">
        	<div class="col-md-3 col-sm-6">
            	<div class="about_info">
                    ...
                    <p>MacAuto è semplicemente un testo fittizio dell'industria della stampa e della composizione. </p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
            	<div class="about_info">
                    ...
                    <h5>Comprare e vendere più velocemente</h5>
                    <p>Lorem Ipsum è semplicemente un testo fittizio dell'industria della stampa e della composizione. </p>
                </div>
            </div>
...
<section id="our_services" class="dark-bg vc_row">
    ...
    <div class=" col-md-6 vc_col section-padding">
        <div class="our_services white-text">
            ...
            <p>Siamo nati ufficialmente nel 2010 come declinazione italiana del sito mobile.de, il più grande marketplace tedesco di autoveicoli. 
			Ogni mese 3 milioni di persone raggiungono 
			il nostro sito e noi le aiutiamo a trovare l’auto perfetta per loro. 
			come puoi notare, forniamo la possbilità agli utenti di vendere le proprie auto attraverso il nostro portale</p>
            <!--Services-info-->
            <div class="services_info">
                ...
                <p>Qui puoi trovare oltre 1000 auto nuove, pronte per essere vendute, sceglia quella che si adatta alle tue esigenze</p>
            </div>
            ...
            <div class="services_info">
                ...
                <p>Sul nostro portale puoi registrarti e mettere in vendita la tua autovettura. Potremmo aiutarti nella vendita</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="row">
      <div id="testimonial-slider-2">
           <div class="testimonial_wrap">
               ...
               <p>Buongiorno consiglio a tutti questa concessionaria per la professionalità, competenza ma soprattutto gentilezza del titolare Paolo. Dopo aver girato diverse concessionarie dove sono stata trattata con superficialità, ho trovato Giancarlo che mi ha saputo consigliare e ha trovato l’auto che cercavo. Consiglierei ai dipendenti di grandi concessionarie di farsi un giretto da Minto per imparare come comportarsi. Alle volte basta poco per soddisfare un cliente.</p>
           </div>
           ...
           <div class="testimonial_wrap">
               ...
               <p>E' TUTTO VERO E RARO. RECENSIONE POSITIVA!! PERSONE QUALIFICATE PRECISE E SOPRATUTTO SPIEGANO AL DETTAGLIO IL CONTRATTO DI VENDITA IN FASE DI ACQUISTO. CONSIGLIO SENZA SORPRESE.</p>
           </div>
           ...
           <div class="testimonial_wrap">
               ...
               <p>Da anni io e mio marito ci affidiamo al Sig. Paolo Maccari, venditore serio e professionale. Per qualsiasi necessità, anche nel post vendita, è sempre a disposizione. Siamo sempre stati soddisfatti e soprattutto ben consigliati. Che dire, 5 stelle sono troppo poche, ne meriterebbe molte di più!.</p>
           </div>
           ...
           <div class="testimonial_wrap">
               ...
               <div class="testimonial-heading">
                  <h5>Roberto Seritella </h5>
                  <span class="client-designation">MacAuto</span> 
               </div>
               <p>E’ già la seconda volta che mi affido a loro e come sempre Giancarlo e il suo staff sono stati disponibili dei professionisti seri e competenti organizzati in tutto, sempre pronti a dare qualsiasi spiegazione. E’ stato un piacere acquistare la mia auto da loro mi hanno supportato durante l'iter di vendita del mio precedente mezzo e sono stati precisi, attenti ai dettagli e molto professionali per l'acquisto della mia nuova macchina. Un lavoro svolto con passione e si percepisce non appena entri nell'auto salone. Grazie per tutto!.</p>
           </div>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="signupform">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer text-center">
        <p>Hai già un account? <a href="#loginform" data-bs-toggle="modal" data-bs-dismiss="modal">Iscriviti qui</a></p>
      </div>
    </div>
  </div>
</div>
